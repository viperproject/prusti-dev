...
impl Runs {
    ...
    #[requires(forall(|i: usize| (self.len() < 2 || (self.len() >= 2 && 0 <= i && i < (self.len() - 1) ==> self.index_start(i) > self.index_start(i + 1)))))]
    ...
    #[ensures(forall(|i: usize| (self.len() < 2 || (self.len() >= 2 && 0 <= i && i < (self.len() - 1) ==> self.index_start(i) > self.index_start(i + 1)))))]
    #[ensures(self.index_start(self.len() - 1) == self.get_runs_sum_max() - self.get_runs_sum_cur())]
    #[ensures(forall(|i: usize| (self.len() < 2 || (self.len() >= 2 && 0 <= i && i < (self.len() - 1) ==> self.index_start(i + 1) + self.index_len(i + 1) == self.index_start(i)))))]
...
#[requires(forall(|i: usize, j: usize| (runs.len() < 2 || (runs.len() >= 2 &&  0 <= i && i < (runs.len() - 1) && j == (i + 1) ==> runs.index_start(j) + runs.index_len(j) == runs.index_start(i)))))]#[ensures(runs.len() == old(runs.len()) + 1)]
