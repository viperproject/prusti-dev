    ...
    for def_id in tcx.hir_body_owners() {
        ...
        match tcx.def_kind(def_id) {
            hir::def::DefKind::Fn | hir::def::DefKind::AssocFn => {
                ...
                // Skip the stub functions generated by `#[extern_spec]`:
                // these only carry the specification of an external function
                // and should not be encoded (nor verified) themselves.
