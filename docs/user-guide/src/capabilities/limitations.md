...
Work on supporting iterators is paused at least until the [pull request to annotate parts of the standard library](https://github.com/viperproject/prusti-dev/pull/138) is completed and merged.
