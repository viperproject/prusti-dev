            ...
            Expr::BinOp(op, ref left, ref right, ref pos) => match left.get_maybe_type() {
                Some(Type::Float(float_ty)) => {
                    ...
                    let float_op_kind = match op {
                        ...
                        BinOpKind::Max => viper::BinOpFloat::Max,
                ...
                Some(Type::BitVector(bitvector_ty)) => match op {
                    BinOpKind::EqCmp => ast.eq_cmp_with_pos(
                        left.to_viper(ast),
                        right.to_viper(ast),
                        pos.to_viper(ast),
                    ),
                    BinOpKind::NeCmp => ast.ne_cmp_with_pos(
                        left.to_viper(ast),
                        right.to_viper(ast),
                        pos.to_viper(ast),
                    ),
                    BinOpKind::GtCmp => ast.gt_cmp_with_pos(
                        left.to_viper(ast),
                        right.to_viper(ast),
                        pos.to_viper(ast),
                    ),
                    BinOpKind::GeCmp => ast.ge_cmp_with_pos(
                        left.to_viper(ast),
                        right.to_viper(ast),
                        pos.to_viper(ast),
                    ),
                    BinOpKind::LtCmp => ast.lt_cmp_with_pos(
                        left.to_viper(ast),
                        right.to_viper(ast),
                        pos.to_viper(ast),
                    ),
                    BinOpKind::LeCmp => ast.le_cmp_with_pos(
                        left.to_viper(ast),
                        right.to_viper(ast),
                        pos.to_viper(ast),
                    ),
                ...
                typ => match op {
                    ...
                    BinOpKind::Mod => ast.module_with_pos(
                        left.to_viper(ast),
                        right.to_viper(ast),
                        pos.to_viper(ast),
                    ),
                    ...
                    BinOpKind::Implies => ast.implies_with_pos(
                        left.to_viper(ast),
                        right.to_viper(ast),
                        pos.to_viper(ast),
                    ),
