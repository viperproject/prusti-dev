...
# Run cargo-clean and cargo-build on all the crates
#
...
export RUSTFLAGS="-Zborrowck=mir -Zpolonius -Znll-facts -Zidentify-regions -Zdump-mir-dir=log/mir/ -Zdump-mir=renumber -Zalways-encode-mir" # "-C overflow-check=yes"
