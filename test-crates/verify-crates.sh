...
# Run cargo-prusti on all the crates
#
...
CARGO_PRUSTI="$DIR/cargo-prusti.sh"
...
export PRUSTI_CHECK_OVERFLOWS="${PRUSTI_CHECK_OVERFLOWS:-false}"
info "Using PRUSTI_CHECK_OVERFLOWS=$PRUSTI_CHECK_OVERFLOWS"
...
export RUSTFLAGS="-Awarnings" # "-C overflow-check=yes"
