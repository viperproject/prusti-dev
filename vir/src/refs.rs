...
typed!(FieldData; Bool => FieldBool, Int => FieldInt, Perm => FieldPerm, Ref => FieldRef, Set => FieldSet);
...
typed!(LocalDeclData; Bool => LocalDeclBool, Int => LocalDeclInt, Perm => LocalDeclPerm, Ref => LocalDeclRef, Set => LocalDeclSet);
