...
pub type CollectionBinOp<'vir> = &'vir crate::data::CollectionBinOpData<'vir>;
pub type CfgBlock<'vir> = &'vir crate::data::CfgBlockData<'vir>;
pub type CfgLabel<'vir> = &'vir crate::data::CfgLabelData<'vir>;
pub type CfgBlockLabel<'vir> = &'vir crate::data::CfgBlockLabelData<'vir>;
...
typed!(ExprData; Bool => ExprBool, Int => ExprInt, Perm => ExprPerm, Ref => ExprRef, Set => ExprSet, Multiset => ExprMultiset, Seq => ExprSeq, Map => ExprMap);
...
typed!(FieldData; Bool => FieldBool, Int => FieldInt, Perm => FieldPerm, Ref => FieldRef, Set => FieldSet, Map => FieldMap);
...
pub type InhaleExhale<'vir> = &'vir crate::data::InhaleExhaleData<'vir>;
pub type Let<'vir> = &'vir crate::data::LetData<'vir>;
typed!(LocalData; Bool => LocalBool, Int => LocalInt, Perm => LocalPerm, Ref => LocalRef, Set => LocalSet, Map => LocalMap);
...
typed!(LocalDeclData; Bool => LocalDeclBool, Int => LocalDeclInt, Perm => LocalDeclPerm, Ref => LocalDeclRef, Set => LocalDeclSet, Map => LocalDeclMap);
...
pub type CollectionLiteral<'vir> = &'vir crate::data::CollectionLiteralData<'vir>;
pub type CollectionUpdate<'vir> = &'vir crate::data::CollectionUpdateData<'vir>;
...
typed!(TypeData; Bool => TypeBool, Int => TypeInt, Perm => TypePerm, Ref => TypeRef, Set => TypeSet, Multiset => TypeMultiset, Seq => TypeSeq, Map => TypeMap);
