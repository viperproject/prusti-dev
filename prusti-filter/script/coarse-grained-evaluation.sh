...
evaluation_log_file="$CRATE_DOWNLOAD_DIR/coarse-grained-evaluation-log-$start_date.log"
evaluation_log_file_final="$CRATE_DOWNLOAD_DIR/coarse-grained-evaluation-log.log"
