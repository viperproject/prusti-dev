    ...
    fn encode_loop(
        ...
        for var in vars {
            let builtin_method = match var.typ {
                ...
                vir::Type::BitVector(vir::BitVector::BV8) => BuiltinMethodKind::HavocBV8,
                vir::Type::BitVector(vir::BitVector::BV16) => BuiltinMethodKind::HavocBV16,
                vir::Type::BitVector(vir::BitVector::BV32) => BuiltinMethodKind::HavocBV32,
                vir::Type::BitVector(vir::BitVector::BV64) => BuiltinMethodKind::HavocBV64,
                vir::Type::BitVector(vir::BitVector::BV128) => BuiltinMethodKind::HavocBV128,
