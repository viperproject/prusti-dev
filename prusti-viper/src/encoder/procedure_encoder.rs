...
impl<'p, 'v: 'p, 'tcx: 'v> ProcedureEncoder<'p, 'v, 'tcx> {
    ...
    fn encode_loan_places(&mut self, loan_places: &LoanPlaces<'tcx>) -> EncodingResult<(polymorphic_vir::Expr, polymorphic_vir::Expr, bool, Vec<polymorphic_vir::Stmt>)> {
    ...
    fn construct_vir_reborrowing_node_for_call(
        ...
        let statement = polymorphic_vir::Stmt::apply_magic_wand(lhs, rhs, loan.into(), pos);
    ...
    fn encode_postcondition_expr(
        ...
        if let Some((mut lhs, mut rhs)) = self.encode_postcondition_magic_wand(
            ...
            magic_wands.push(polymorphic_vir::Expr::magic_wand(lhs, rhs, loan.map(|l| l.into())));
        }
            ...
            mir::Operand::Copy(ref place) => {
                ...
                let encode_stmts = if self.mir_encoder.is_reference(ty) {
                    ...
                    stmts.push(polymorphic_vir::Stmt::Assign( polymorphic_vir::Assign {
                        ...
                        kind: polymorphic_vir::AssignKind::SharedBorrow(loan.into()),
                    }));
                    stmts
                } else {
    ...
    fn encode_assign_ref(
        ...
        let (vir_assign_kind, array_encode_kind) = match mir_borrow_kind {
            mir::BorrowKind::Shared =>
                (polymorphic_vir::AssignKind::SharedBorrow(loan.into()), ArrayAccessKind::Shared),
            ...
            mir::BorrowKind::Mut { .. } =>
                (polymorphic_vir::AssignKind::MutableBorrow(loan.into()), ArrayAccessKind::Mutable(Some(loan.into()), location)),
        };
    ...
    fn prepare_assign_target(
        ...
        if !self.init_info.is_vir_place_accessible(&dst, location) {
            ...
            let acc = polymorphic_vir::Expr::acc_permission(dst_field, polymorphic_vir::PermAmount::Write);
            alloc_stmts.push(polymorphic_vir::Stmt::Inhale( polymorphic_vir::Inhale {
                expr: acc,
            }));
