...
pub(in super::super::super::super::super) struct OwnedAliasedRangeSnapCallBuilder<
    'l,
    'p,
    'v,
    'tcx,
...
impl<'l, 'p, 'v, 'tcx, G> OwnedAliasedRangeSnapCallBuilder<'l, 'p, 'v, 'tcx, G>
where
    G: WithLifetimes + WithConstArguments,
{
    pub(in super::super::super::super::super) fn new(
        ...
        let arguments = vec![address, start_index, end_index];
