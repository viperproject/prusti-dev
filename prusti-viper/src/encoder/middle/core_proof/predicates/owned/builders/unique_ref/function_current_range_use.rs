...
// FIXME: Code identical to `FracRefRangeSnapCallBuilder`.
pub(in super::super::super::super::super) struct UniqueRefCurrentRangeSnapCallBuilder<
    'l,
    'p,
    'v,
    'tcx,
...
impl<'l, 'p, 'v, 'tcx, G> UniqueRefCurrentRangeSnapCallBuilder<'l, 'p, 'v, 'tcx, G>
where
    G: WithLifetimes + WithConstArguments,
{
