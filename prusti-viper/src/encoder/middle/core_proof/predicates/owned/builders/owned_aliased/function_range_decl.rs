...
pub(in super::super::super) struct OwnedAliasedRangeSnapFunctionBuilder<'l, 'p, 'v, 'tcx> {
...
impl<'l, 'p, 'v, 'tcx> OwnedAliasedRangeSnapFunctionBuilder<'l, 'p, 'v, 'tcx> {
    ...
    pub(in super::super::super) fn add_owned_precondition(&mut self) -> SpannedEncodingResult<()> {
        ...
        let predicates = self.inner.lowerer.owned_aliased_range(
