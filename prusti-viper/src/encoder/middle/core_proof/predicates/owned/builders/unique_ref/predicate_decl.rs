...
impl<'l, 'p, 'v, 'tcx> UniqueRefBuilder<'l, 'p, 'v, 'tcx> {
    ...
    pub(in super::super::super) fn add_field_predicate(
        ...
        //     self.inner.position,
        // )?;
        let current_field_snapshot = true.into();
        let final_field_snapshot = true.into();
    ...
    pub(in super::super::super) fn add_discriminant_predicate(
        ...
        let current_discriminant_snapshot = true.into();
        let final_discriminant_snapshot = true.into();
        let expression = self.inner.lowerer.unique_ref_predicate(
            CallContext::BuiltinMethod,
            &decl.discriminant_type,
            &decl.discriminant_type,
    ...
    pub(in super::super::super) fn add_quantified_permission(
        ...
        //     self.inner.position,
        // )?;
        let current_element_snapshot = true.into(); // FIXME
        let final_element_snapshot = true.into(); // FIXME
