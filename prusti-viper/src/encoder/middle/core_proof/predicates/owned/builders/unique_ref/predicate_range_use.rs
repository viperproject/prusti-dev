...
// FIXME: Identical code with `FracRefRangeUseBuilder`.
pub(in super::super::super::super::super) struct UniqueRefRangeUseBuilder<'l, 'p, 'v, 'tcx, G>
where
...
impl<'l, 'p, 'v, 'tcx, G> UniqueRefRangeUseBuilder<'l, 'p, 'v, 'tcx, G>
where
    G: WithLifetimes + WithConstArguments,
{
    ...
    pub(in super::super::super::super::super) fn build(
        ...
        let size = self
            .lowerer
            .encode_type_size_expression2(&ty.target_type, &*ty.target_type)?;
        ...
        // let predicate = self.lowerer.unique_ref(
        //     self.context,
        //     &ty.target_type,
        //     self.generics,
        //     element_place,
