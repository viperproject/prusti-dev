...
pub(in super::super) struct MemoryBlockSplitJoinMethodBuilder<'l, 'p, 'v, 'tcx> {
    pub(super) inner: BuiltinMethodBuilder<'l, 'p, 'v, 'tcx>,
    pub(super) address: vir_low::VariableDecl,
    pub(super) permission_amount: vir_low::VariableDecl,
    pub(super) discriminant: Option<vir_low::VariableDecl>,
}

impl<'l, 'p, 'v, 'tcx> BuiltinMethodBuilderMethods<'l, 'p, 'v, 'tcx>
    for MemoryBlockSplitJoinMethodBuilder<'l, 'p, 'v, 'tcx>
{
...
impl<'l, 'p, 'v, 'tcx> MemoryBlockSplitJoinMethodBuilder<'l, 'p, 'v, 'tcx> {
    ...
    pub(in super::super) fn create_parameters(&mut self) -> SpannedEncodingResult<()> {
        ...
        if let Some(discriminant) = &self.discriminant {
            self.inner.parameters.push(discriminant.clone());
        }
        Ok(())
    }
