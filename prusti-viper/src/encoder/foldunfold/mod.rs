...
impl<'b, 'a: 'b> FallibleExprFolder for ExprReplacer<'b, 'a> {
    ...
    /*fn fallible_fold_field(
        ...
        trace!("[enter] fallible_fold_field {}, {}", base, field);
        ...
        trace!("[exit] fallible_fold_field = {}", res);
        Ok(res)
    }*/
    ...
    /*fn fallible_fold_func_app(&mut self, func_app: vir::FuncApp) -> Result<vir::Expr, Self::Error> {
        if self.wait_old_expr {
            ...
            trace!("[enter] fallible_fold_func_app {}", func_app);
            ...
            trace!("[exit] fallible_fold_func_app {}", result);
            Ok(result)
        }
    }*/
    ...
    /*fn fallible_fold_domain_func_app(
        ...
        if self.wait_old_expr {
            ...
            trace!("[enter] fallible_fold_domain_func_app {}", domain_func_app);
            ...
            trace!("[exit] fallible_fold_domain_func_app {}", result);
            Ok(result)
        }
    }*/
